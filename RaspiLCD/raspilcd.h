...
#define		BUTTON_PRESSED_NEW		(ButtonPressed & 0x20)
*/
#define		BUTTON_DOWN				(Button & 1)
#define		BUTTON_UP				(Button & (1<<1))
#define		BUTTON_MIDDLEV				(Button & (1<<2))	//MIDDLE VERTICAL
#define		BUTTON_LEFT				(Button & (1<<3))
#define		BUTTON_MIDDLEH				(Button & (1<<4))	//MIDDLE HORIZONTAL
#define		BUTTON_RIGHT				(Button & (1<<5))	

#define		BUTTON_PRESSED_DOWN		(ButtonPressed & 1)
#define		BUTTON_PRESSED_UP		(ButtonPressed & (1<<1))
#define		BUTTON_PRESSED_MIDDLEV		(ButtonPressed & (1<<2))
#define		BUTTON_PRESSED_LEFT		(ButtonPressed & (1<<3))
#define		BUTTON_PRESSED_MIDDLEH		(ButtonPressed & (1<<4))
#define		BUTTON_PRESSED_RIGHT		(ButtonPressed & (1<<5))
